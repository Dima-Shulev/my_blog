...
return [
    ...
    */
    ...
    'password'         => [
        ...
        'mixed'         => 'Поле :attribute должно содержать по крайней мере одину заглавную и одну маленькую букву.',
        'numbers'       => 'Поле :attribute должно содержать по крайней мере одну цифру.',
        'symbols'       => 'Поле :attribute должно содержать по крайней мере один специальны символ (:,#,-,_,+ и т.п).',

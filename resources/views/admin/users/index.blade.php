                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-start">
                            <a href="{{route('admin.users.publicUser',[$user->id,$user->active])}}" class="btn btn-sm btn-{{$user->active == 1 ? 'danger': 'success'}} mb-1 me-1">{{$user->active == 1?'Деактивировать':'Активировать'}}</a>

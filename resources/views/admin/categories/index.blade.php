       ...
       @else
            ...
            @foreach($categories as $category)
                <tr>
                    ...
                    <td>
                        <a href="{{route('admin.categories.publicCategory',[$category->id,$category->active])}}" class="btn btn-sm btn-{{$category->active == 1 ? 'danger': 'success'}} mb-1 me-1">{{$category->active == 1?'Деактивировать':'Активировать'}}</a>

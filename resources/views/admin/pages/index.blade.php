            ...
            <table class="table">
                ...
                @foreach($pages as $page)
                    <tr>
                        ...
                        <td>{{$page->active}}</td>
                        <td>
                            <a href="{{route('admin.pages.publicPage',[$page->id,$page->active])}}" class="btn btn-sm btn-{{$page->active == 1 ? 'danger': 'success'}} mb-1 me-1">{{$page->active == 1?'Деактивировать':'Активировать'}}</a>
